...
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(VAGradientDirection)directionType optionSize:(CGSize)size{
    ...
    if (directionType == VALinearGradientDirectionLevel) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }else if (directionType == VALinearGradientDirectionVertical){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(0, 1);
    }else if (directionType == VALinearGradientDirectionUpwardDiagonalLine){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 1);
    }else if (directionType == VALinearGradientDirectionDownDiagonalLine){
...
+ (void)addLinearGradientForlabelText:(UIView *)parentView label:(UILabel *)label start:(UIColor *)startColor and:(UIColor *)endColor;{
    ...
    chromatoLayer.mask = label.layer;
